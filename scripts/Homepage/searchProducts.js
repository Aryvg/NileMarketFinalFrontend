...
export async function searchProducts(query) {
  try {
    ...
    const response = await fetch(`https://nilemarketfinalbackend.onrender.com/products/search?name=${encodeURIComponent(query)}`, { headers });
    if (!response.ok) {
    ...
    document.querySelector('.js-main').innerHTML = '<p style="color:white">Products not found</p>';
  }
}